...
@Component({
  selector: 'app-popup-form-pelicula',
  templateUrl: './popup-form-pelicula.component.html',
  styleUrls: ['./popup-form-pelicula.component.css']
})
export class PopupFormPeliculaComponent implements OnInit {
